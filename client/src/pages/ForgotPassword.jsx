    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                addNotification(data.message || 'Failed to send reset link', 'error');
            }
        } catch (err) {
            console.error(err);
        ...
        <div className="min-h-screen bg-dovoc-beige flex items-center justify-center p-4">
            <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-dovoc-dark">Reset Password</h2>
                ...
                <div className="mt-6 text-center text-sm">
                    <Link to="/login" className="flex items-center justify-center text-gray-500 hover:text-dovoc-dark">
